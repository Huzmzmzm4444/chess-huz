...
- Настройка уровней сложности: В зависимости от силы противника мы включили возможность настраивать уровень сложности бота. Это позволило адаптировать алгоритм в соответствии с опытом и навыками игрока.
